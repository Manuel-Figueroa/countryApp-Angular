...
export class CountrisService {
  ...
  public cacheStore:CacheStore={
    byCapital:{terms:'',countries:[]},
    byCountries:{terms:'',countries:[]},
  ...
  searchCapital(term:string):Observable<Country[]>{
    ...
    .pipe(
      tap( countries => this.cacheStore.byCapital={terms:term,countries}),
  ...
  searchCountry(term:string):Observable<Country[]>{
    ...
    return this.getCountriesResquest(url)
    .pipe(
      tap( countries => this.cacheStore.byCountries={terms:term,countries}),
      tap(()=> this.saveToLocalStorange()),
    )
  }
